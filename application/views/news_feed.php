						...
						<div class="row merged20" id="page-contents">
								...
								<aside class="sidebar static left">
									...
									<div class="widget stick-widget">
										...
										<ul class="fav-community">
											...
											<li><i class="fa fa-map-marker"></i><a href="http://wpkixx.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="7f301c1a1e112012100b1a133f06100a0d121e1613511c1012">[email&#160;protected]</a></li>
										</ul>
									</div>
							...
							<div class="col-lg-12">
									...
									<div class="central-meta">
										<div class="row">
											<div class="col-lg-12">
												<?php foreach($rssfeed as $rssfeed1){ ?>
												<div class="event-box">
													<div class="row merged20">
														<div class="col-lg-4 col-md-4 col-sm-5">
															<figure class="event-thumb">
																<a href="<?php echo base_url().'home/news_description/'.$rssfeed1->id?>">
																	<img  src="<?php echo $rssfeed1->image_url;?>" alt="">
																</a>
															</figure>
														</div>
														<div class="col-lg-6 col-md-6 col-sm-5">
															<div class="event-title">
																<span><i class="fa fa-clock-o"><?php echo $rssfeed1->created_at; ?></i></span>
																<h4>
																	<a href="<?php echo base_url().'home/news_description/'.$rssfeed1->id?>" title=""><?php echo $rssfeed1->title; ?>
																	</a>
																	<?php if(isset($_SESSION['logged_in']))
																	{
																	?>
																		<a href="<?php echo base_url().'home/delete_news/'.$rssfeed1->id?>">
																...
																<p>
																	<?php
																	$no_of_words=str_word_count($rssfeed1->description,0);
																		if($no_of_words<30)
																		{
																			echo $rssfeed1->description;
																		}
																		else
																		{
																			echo trim_text($rssfeed1->description, 30);
																		}
																	?>
																	<!-- <p style="color: blue;"> -->
																	<a href="<?php echo $rssfeed1->url;?>">
																		<b style="color: blue;">See Detail</b>
																	</a>
																<!-- </p> -->
																</p>
																...
																<ul class="sociaz-media">
																	<li>
																		<a title="" href="https://www.facebook.com/sharer.php?t=XBOX&u=<?php echo $rssfeed1->url;?>" class="facebook">
																	...
																	<li><a title="" href="https://twitter.com/intent/tweet?text=<?php echo $rssfeed1->url;?>" class="twitter"><i class="fa fa-twitter"></i></a></li>
														...
														<div class="col-lg-2 col-md-2 col-sm-2">
															<div class="event-time">
																<span class="event-date">
																	<?php 
																		$date = new DateTime($rssfeed1->created_at);
											...
											?>
												...
												<!-- <div class="event-box">
													<div class="row merged20">
														<div class="col-lg-4 col-md-4 col-sm-5">
															<figure class="event-thumb"><img src="<?php echo base_url();?>public/images/resources/event5.jpg" alt=""></figure>
														</div>
														<div class="col-lg-6 col-md-6 col-sm-5">
															<div class="event-title">
